...
// v2
// // Sidebar.tsx - auto-opens sidebar but it's breaking sidebar design
// import React, { useEffect, useState } from 'react';
// import { NavLink } from 'react-router-dom';
// import { useAuth } from '@/hooks/useAuth';
// import { normalizeRoles, hasRole } from '@/utils/auth/roles';
// import type { UserRole } from '@/types/users';
...
//   /* ✅ FULL THEME-CORRECT SIDEBAR TOGGLING */
//   useEffect(() => {
//     const nav = document.querySelector('.dz-nav-floting');
...
//       <aside className="sidebar dz-floting-sidebar">
//         <div className="sidebar-header">
//           <NavLink to="/" onClick={onClose}>
//             <div className="app-logo">
//               <img src="/assets/images/app-logo/dunis_academ.png" alt="Dunistech" />
//             </div>
//           </NavLink>
