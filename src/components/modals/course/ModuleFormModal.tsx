...
// import type { ModuleCreate, ModuleUpdate, Module } from '@/types/course';
...
//     // Check if order conflicts with existing modules (except when editing current module)
//     /*
//     if (!isEditing || (module && formData.order !== module.order)) {
//       if (existingOrders.includes(formData.order)) {
//         newErrors.order = `Module with order ${formData.order} already exists`;
//       }
//     }*/
//     //    
//     // Ignore current module's order when editing
//     const conflictingOrders = isEditing && module
//     ? existingOrders.filter(o => o !== module.order)
//     : existingOrders;

//     if (conflictingOrders.includes(formData.order)) {
//     newErrors.order = `Module with order ${formData.order} already exists`;
//     }
...
//                   Determines the display order of this module
//                 </small>
//               </div>
//             </div>
...
//       // When editing: exclude the current module's original order from the check
//       // When creating: check against all existing orders
//       const shouldCheckConflict = isEditing && module
//         ? formData.order !== module.order // Only check if order actually changed
//         : true; // Always check when creating
