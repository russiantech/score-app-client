...
import { FormSelect } from '@/components/forms/Forms';
                  ...
                  <div className="card bg-light border-0">
                    <div className="card-body p-3">
                      <div className="d-flex align-items-center">
                        <UserAvatar 
                          names={selectedParentData.names || ''} 
                          size={48} 
                          bgColor="bg-info"
                        />
...
const ParentChildLinks: React.FC = () => {
  ...
  const fetchInitialData = async () => {
    try {
      ...
      setParents(Array.isArray(parentsResponse) ? parentsResponse : (parentsResponse as any)?.data?.users || []);
      setChildren(Array.isArray(studentsResponse) ? studentsResponse : (studentsResponse as any)?.data?.users || []);
  ...
  const fetchLinks = useCallback(async () => {
    try {
      ...
      const totalCount =
        typeof metaData === 'object' && metaData !== null && 'total_items_count' in metaData
          ? (metaData as { total_items_count?: number }).total_items_count ?? linksData.length
          : linksData.length;
      setTotal(totalCount);
      
      const pages =
        typeof metaData === 'object' && metaData !== null && 'total_pages_count' in metaData
          ? (metaData as { total_pages_count?: number }).total_pages_count ?? Math.ceil(totalCount / pageSize)
              ...
              {loading ? (
                ...
                <>
                  ...
                  <div className="d-block d-lg-none">
                    {links.map(link => {
                      // const parent = (link.parent ?? {}) as Partial<User>;
                      // const child = (link.child ?? {}) as Partial<User>;
                      const parent = (link.parent || {}) as Partial<User>;
                      const child = (link.child || {}) as Partial<User>;
                        ...
                        <div key={link.id} className="border-bottom p-3">
                          <div className="d-flex justify-content-between align-items-start mb-2">
                            <div className="d-flex align-items-center flex-grow-1 overflow-hidden">
                              <UserAvatar names={parent.names || 'NA'} size={40} bgColor="bg-info" className="flex-shrink-0" />
                          ...
                          <div className="mb-3 ps-5 ms-2">
                            <div className="d-flex align-items-center">
                              <UserAvatar names={child.names || 'NA'} size={32} bgColor="bg-success" className="flex-shrink-0" />
                          ...
                          {links.map(link => {
                            ...
                            return (
                              <tr key={link.id}>
                                <td className="ps-4">
                                  <div className="d-flex align-items-center">
                                    <UserAvatar names={parent.names || 'NA'} bgColor="bg-info" />
                                ...
                                <td>
                                  <div className="d-flex align-items-center">
                                    <UserAvatar names={child.names || 'NA'} bgColor="bg-success" />
                                    <div className="ms-3 overflow-hidden" style={{ maxWidth: '200px' }}>
                                      <div className="fw-bold text-truncate">{child.names || 'Unknown'}</div>
                  ...
                  <div className="d-flex flex-wrap gap-2">
                    {unlinkedChildren.slice(0, 5).map(student => (
                      ...
                      >
                        ...
                        {/* Link {student.names.split(' ')[0] || 'Student'} */}
                        Link {student.names?.split(' ')[0] || 'Student'}
                      </button>
                    ))}
                        ...
                        <div className="col-12 col-sm-6 col-lg-4 col-xl-3" key={parent.id}>
                          <div className="border rounded p-3 h-100 bg-light">
                            <div className="d-flex align-items-center mb-3">
                              <UserAvatar names={parent.names || 'Unknown Parent'} size={48} bgColor="bg-info" className="flex-shrink-0" />
                              <div className="ms-3 flex-grow-1 overflow-hidden">
                              ...
                              <>
                                ...
                                <div className="small" style={{ maxHeight: '150px', overflowY: 'auto' }}>
                                  {parentLinks.map(link => {
                                    // Ensure child is typed as Partial<User> or fallback to empty object
                                    const child = (link.child ?? {}) as Partial<User>;
                                    return (
                                      <div
                                        key={link.id}
                                      ...
                                      >
                                        <div className="flex-grow-1 overflow-hidden me-2">
                                          <div className="fw-semibold text-truncate" title={child.names ?? 'Unknown'}>
                                            {child.names ?? 'Unknown'}
                                          </div>
                  ...
                  <div className="card-body">
                    <div className="row g-3">
                      <div className="col-12 col-md-6">
                        ...
                        <div className="d-flex align-items-center">
                          <UserAvatar 
                            names={linkToUnlink.parent?.names || 'Unknown'} 
                            size={48}
                            bgColor="bg-danger"
                          />
                          <div className="ms-3 overflow-hidden">
                      ...
                      <div className="col-12 col-md-6">
                        ...
                        <div className="d-flex align-items-center">
                          <UserAvatar 
                            names={linkToUnlink.child?.names || 'Unknown'} 
                            size={48}
                            bgColor="bg-success"
                          />
                          <div className="ms-3 overflow-hidden">
