...
//       return NotificationService.showToast('Valid email is required', 'error');
//     }
...
//         reset_code: resetCode.toUpperCase().trim(),
...
//                 The email where you received the reset code
//               </small>
//             </div>
...
//               />
//               <small className="form-text text-muted">
//                 Check your email for the {CODE_LENGTH}-digit reset code
//               </small>
//             </div>
